...
<template>
  ...
  <div class="min-h-screen bg-[#050507] text-white relative isolate flex flex-col items-center justify-center p-6 overflow-x-hidden" style="font-family: 'Space Grotesk', 'Cairo', sans-serif;">
    <!-- Ambient -->
    ...
    <!-- Optional minimal logo -->
    <Link :href="home()" class="absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-3 group z-10">
